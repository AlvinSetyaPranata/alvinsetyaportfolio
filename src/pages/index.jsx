                ...
                >
                    <motion.div className='container h-max box-border max-w-[1200px] grid w-full mx-auto relative'>
                        ...
                        <section className={`flex flex-col ${section_baseclass}`}>
                            ...
                            <div className='grid my-auto place-items-center md:px-6 md:place-items-start'>
                                <motion.h1
                                    className='text-4xl text-center font-bold text-lavender-600 md:text-6xl xl:text-7xl md:text-left font-headings'
                                    initial="hideHeading"
                                ...
                                <div className='my-8 flex flex-wrap md:flex-row gap-8 justify-center py-4 box-border w-fit items-center'>
                                    <motion.button
                                        ...
                                        whileHover="onHover"
                                    >
                                        <Link href="/about">Introduce me</Link>
                                    </motion.button>
                                    <motion.button
                    ...
                    <section className='relative z-10 py-12 h-fit w-full section-full bg-lavender-600 overflow-hidden' ref={contact}>
                        ...
                        >
                            ...
                            <div className='flex items-center gap-4 md:gap-6 my-8'>
                        ...
                        <Link className='right-[10%] md:right-[25%] top-[50%] md:top-[40%] text-lavender-500 font-semibold text-sm md:text-base py-[12px] md:py-[12px] px-4 md:px-6 bg-white absolute rounded-md' href="/projects">My Projects</Link>
                    </section>
